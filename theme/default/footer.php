...
<div class="wrapper clearfix" id="colophon">
    ...
    <div class="grid_4"><h3 style="font-size:20px;">Our Products</h3>    
        ...
        <dd class="nav-item">
        <a href="http://codecanyon.net/item/turbo-seo-analyzer/8037745">Turbo SEO Analyzer </a>
        </dd>
        ...
        <dd class="nav-item">
        <a href="http://codecanyon.net/item/custom-openvpn-gui/7423999">Custom OpenVPN GUI</a>
        </dd>
