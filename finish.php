...
ip VARCHAR(255)
   ...
   $query = "INSERT INTO admin_history (last_date,ip) VALUES ('14th June 2014','23.54.2.43')"; 
   mysqli_query($con,$query);
   $query = "INSERT INTO admin_history (last_date,ip) VALUES ('14th June 2014','26.32.34.33')"; 
   mysqli_query($con,$query);
   $query = "INSERT INTO admin_history (last_date,ip) VALUES ('15th June 2014','31.7.42.03')"; 
   mysqli_query($con,$query);
...
last_date VARCHAR(255)
    ...
    echo "Error creating table: " . mysqli_error($con)."<br>";
     ...
     $query = "INSERT INTO ban_user (id,ip,last_date) VALUES ('1','2.2.2.2','17th June 2014')"; 
     mysqli_query($con,$query);
...
page_content text
    ...
    echo "Error creating table: " . mysqli_error($con)."<br>";
     ...
     $query = "INSERT INTO pages (id,last_date,page_name,page_title,page_content) VALUES ('1','17th June 2014','about','About US','<p><strong>Nothing to say</strong></p><br><br><br><br><br><br><br><br><br><br>')"; 
     mysqli_query($con,$query);
